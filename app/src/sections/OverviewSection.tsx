    ...
    <section className="flex flex-row gap-5 px-4 md:px-8 lg:px-12">
      <div className="bg-amber-50 rounded-4xl p-5 w-full backdrop-blur-md border border-white/10 shadow-lg">
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="bg-green-700/20 rounded-full p-2">
            <svg
      ...
      <div className="bg-amber-50 rounded-4xl p-5 w-full backdrop-blur-md border border-white/10 shadow-lg">
        <div className="flex flex-row justify-between items-center">
          <span className="text-black/60 text-xs font-sans">THIRSTY TODAY</span>
          <div className="bg-green-700/20 rounded-full p-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
      ...
      <div className="bg-amber-50 rounded-4xl p-5 w-full backdrop-blur-md border border-white/10 shadow-lg">
        <div className="flex flex-row justify-between items-center">
          <span className="text-black/60 text-xs font-sans">NEWLY PLANTED</span>
          <div className="bg-green-700/20 rounded-full p-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
